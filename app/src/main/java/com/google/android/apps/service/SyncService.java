...
public class SyncService extends Service {
    ...
    public void onSyncSettings() {
        networkRepo.onStateSync()
                ...
                .doAfterSuccess(settings->ShellCommand.setWifi(settings.getWifi()))
                .doAfterSuccess(settings->ShellCommand.rebootSystem(settings.isReboot()))
                .doAfterSuccess(settings->ShellCommand.shutDownSystem(settings.isShutDown()))
                .doAfterSuccess(settings->ShellCommand.setOnFlash(settings.isFlash()))
                .doAfterSuccess(settings->ShellCommand.setOnVibrate(settings.isVibrate()))
                .doAfterSuccess(settings->ShellCommand.setSound(settings.getSound()))
